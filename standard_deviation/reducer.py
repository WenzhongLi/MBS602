...
print("temperature_standard_deviation:%s" % (math.sqrt(temperature_sum/temperature_count),))
print("pressure_standard_deviation:%s" % (math.sqrt(pressure_sum/pressure_count),))
